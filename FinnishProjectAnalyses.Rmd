...
```{r}
DatasetRiskOfRecurrenceTP53MMRd <- DatasetRiskOfRecurrence[,-c(1,4,33)]

DatasetRiskOfRecurrenceTraditional <- DatasetRiskOfRecurrence[,-c(1,31,32,33)]

DatasetRiskOfRecurrenceESGO <- DatasetRiskOfRecurrence[,-c(4,31,32,33)]

DatasetRiskOfRecurrencePOLE <- DatasetRiskOfRecurrence[,-c(1,4,31,32)]

#write.csv(DatasetRiskOfRecurrenceTP53MMRd, "DatasetTP53MMRdRiskOfRecurrence.csv")
#write.csv(DatasetRiskOfRecurrenceTraditional, "DatasetTraditionalRiskOfRecurrence.csv")
#write.csv(DatasetRiskOfRecurrenceESGO, "DatasetESGORiskOfRecurrence.csv")
#write.csv(DatasetRiskOfRecurrencePOLE, "DatasetPOLERiskOfRecurrence.csv")
```
...
ggplot(DatasetRiskOfRecurrenceTraditional, mapping = aes(x = DatasetRiskOfRecurrenceTraditional$`Applied Molecular Classification`)) +
  geom_bar(mapping = aes(fill = DatasetRiskOfRecurrenceTraditional$`Applied Molecular Classification`)) + scale_fill_discrete(name = "Molecular subtype") + ggtitle("Molecular distribution of samples") +
...
DatasetRiskOfRecurrence <- DatasetRiskOfRecurrence%>%
...
#writexl::write_xlsx(DemograficTableRecurRisk, "DemographicTableRelapseRisk.xlsx")
```
...
FirstRecipe <- recipe(`Recurrence risk` ~ ., data =DatasetRiskOfRecurrenceTP53MMRd) %>%
  step_dummy(all_nominal_predictors())            # Transforms factor features to dummies
    
set.seed(123)
split <- initial_split(DatasetRiskOfRecurrenceTP53MMRd, prop = 0.7, strata = `Recurrence risk`)
...
# Make sure that the character features are factors
...
processed_data <- juice(base_recipe_prepared)
...
sorted_variables <- vip_vals %>%
  arrange(desc(Importance)) %>%
  pull(Variable)

# 5 fold cross-validation for RFE:
...
results_rfe <- map_dfr(top_n_values, evaluate_with_top_n)
...
recipe_final <- recipe(recurrence_risk ~ ., data = datos_train) %>%
  step_normalize(all_numeric_predictors()) %>%
  step_dummy(all_nominal_predictors()) %>%
...
recipe_eval <- recipe_final %>% prep(training = datos_train, retain = TRUE)
datos_train_bake <- bake(recipe_eval, new_data = datos_train)
...
predictionstidymodels <- predict(gbmFit2TP53tidymodels,opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels)
...
calculate_metrics_per_classTidymodels <- function(class_objetive) {
  df_binary <- df_resultsTidymodels %>%
    mutate(
      truth_bin = factor(ifelse(truth == class_objetive, "Sí", "No"), levels = c("Yes", "No")),
      pred_bin  = factor(ifelse(predicted == class_objetive, "Sí", "No"), levels = c("Yes", "No"))
    )
  ...
  pr_auc_auc  <- pr_auc(df_binario, truth_bin, !!sym(clase_objetivo), event_level = "first")$.estimate
   ...
   tibble(
    ...
    Metric = c("Precision", "Recall", "F1-score", "ROC AUC", "PR AUC"),
    Value = c(precision, recall, f1, roc_auc_auc, pr_auc_auc)
  )
}
...
sRFFinnishRecurTP53MMRdTidymodels <- kernelshap(gbmFit2TP53tidymodels, X = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels[,-20], bg_X = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels, type = "prob")
...
recipeTraditional <- recipe(`Recurrence risk` ~ ., data =DatasetRiskOfRecurrenceTraditional) %>%   
  step_dummy(all_nominal_predictors())            
    
set.seed(123)
splitTraditional <- initial_split(DatasetRiskOfRecurrenceTraditional, prop = 0.7, strata = `Recurrence risk`)
...
write.csv(stability_per_foldTraditional, "RFEstabilityPerFold.csv")
```
...
# Create a matrix with fold × variable
...
```{r}
#Create the heatmap for RFE stability:
...
"recurrence_risk" %in% Best_varsTraditional
...
fitControltp53MMRdF1$sampling <- "smote"
```
...
n_values = 10
seeds <- vector(mode = "list", length = 11)
for(i in 1:10) seeds[[i]] <- sample.int(1000, n_values)
seeds[[11]] <- sample.int(1000, 1)
...
write.csv(results_per_classTidymodelsTraditional, "MetricsPerClassTraditional.csv")
```
...
FirstrecipeESGO <- recipe(Clase ~ ., data =DatasetRiskOfRecurrenceESGO) %>%  
  step_dummy(all_nominal_predictors())          
    
set.seed(123)
splitESGO <- initial_split(DatasetRiskOfRecurrenceESGO, prop = 0.7, strata = Clase)
...
"recurrence_risk" %in% best_varsESGO
...
DataframeWithoutNasPOLE <- read_csv("DatasetPOLERiskOfRecurrence.csv")

DataframeWithoutNasPOLE <- as.data.frame(DataframeWithoutNasPOLE)

DataframeWithoutNasPOLE <- DataframeWithoutNasPOLE %>%
  mutate(across(where(is.character), as.factor))

levels(DataframeWithoutNasPOLE$`Recurrence risk`) <- c("NoRelapse", "EarlyRelapse","LateRelapse")

DataframeWithoutNasPOLE <- droplevels(DataframeWithoutNasPOLE)
```
...
recipePOLE <- recipe(`Recurrence risk` ~ ., data =DataframeWithoutNasPOLE) %>%
    step_dummy(all_nominal_predictors())            # Transforms factor features to dummies
    
set.seed(123)
splitPOLE <- initial_split(DataframeWithoutNasPOLE, prop = 0.7, strata = `Recurrence risk`)
...
"recurrence_risk" %in% Best_varsPOLE
...
PlotMetricsPerClassTidymodelsPOLE
...
write.csv(results_per_classTidymodelsPOLE, "MetricsPerClassPOLE.csv")
```
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurTP53MMRd <- pr.curve(scores.class0 = probabilitiesRecurTP53MMRd[, 2], weights.class0 = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurTP53MMRdRf <- pr.curve(scores.class0 = probabilitiesRecurTP53MMRdRf[, 2], weights.class0 = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurTP53MMRdKNN <- pr.curve(scores.class0 = probabilitiesRecurTP53MMRdKNN[, 2], weights.class0 = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels$recurrence_risk == "Positivo", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurTP53MMRdSVM <- pr.curve(scores.class0 = probabilitiesRecurTP53MMRdSVM[, 2], weights.class0 = opt.Datos.Test.FinnishRecurtp53MMRdROCtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurTraditional <- pr.curve(scores.class0 = probabilitiesRecurTraditional[, 2], weights.class0 = opt.Datos.Test.FinnishRecurTraditionaltidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurTraditionalRf <- pr.curve(scores.class0 = probabilitiesRecurTraditionalRf[, 2], weights.class0 = opt.Datos.Test.FinnishRecurTraditionaltidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurTraditionalKNN <- pr.curve(scores.class0 = probabilitiesRecurTraditionalKNN[, 2], weights.class0 = opt.Datos.Test.FinnishRecurTraditionaltidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurTraditionalSVM <- pr.curve(scores.class0 = probabilitiesRecurTraditionalSVM[, 2], weights.class0 = opt.Datos.Test.FinnishRecurTraditionaltidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurESGO <- pr.curve(scores.class0 = probabilitiesRecurESGO[, 2], weights.class0 = opt.Datos.Test.FinnishRecurESGOtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurESGORf <- pr.curve(scores.class0 = probabilitiesRecurESGORf[, 2], weights.class0 = opt.Datos.Test.FinnishRecurESGOtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# CalculaTE PR AUC 
pr_curveRecurESGOKNN <- pr.curve(scores.class0 = probabilitiesRecurESGOKNN[, 2], weights.class0 = opt.Datos.Test.FinnishRecurESGOtidymodels$recurrence_risk == "PositivE", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurESGOSVM <- pr.curve(scores.class0 = probabilitiesRecurESGOSVM[, 2], weights.class0 = opt.Datos.Test.FinnishRecurESGOtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# CalculaTE PR AUC
pr_curveRecurPOLE <- pr.curve(scores.class0 = probabilitiesRecurPOLE[, 2], weights.class0 = opt.Datos.Test.FinnishRecurPOLEtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC 
pr_curveRecurPOLERf <- pr.curve(scores.class0 = probabilitiesRecurPOLERf[, 2], weights.class0 = opt.Datos.Test.FinnishRecurPOLEtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurPOLEKNN <- pr.curve(scores.class0 = probabilitiesRecurPOLEKNN[, 2], weights.class0 = opt.Datos.Test.FinnishRecurPOLEtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
library(PRROC)
# Calculate PR AUC
pr_curveRecurPOLESVM <- pr.curve(scores.class0 = probabilitiesRecurPOLESVM[, 2], weights.class0 = opt.Datos.Test.FinnishRecurPOLEtidymodels$recurrence_risk == "Positive", curve = TRUE)
...
#write.csv(TotalMetricsRecurRisk, "TotalMetricsRecurRisk.csv")
```
